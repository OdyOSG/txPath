...
#'
#' @description This function defines the parameters for an individual treatment
#'   history analysis. These settings are based on TreatmentPatterns package
#'   available from DARWIN. Upon cohort specification, the user can input
#'   parameters for the treatment history construction. A treatment history
#'   data.frame is constructed based on the following options:
#' \itemize{
...
#' }
#'   Options for filterTreatments include 'First" which limits the pathway to
#'   the first occurrence of a treatment, 'Changes' which removed sequential
#'   repeated treatments or 'All' which includes all treatments. There are
#'   additional options such as maxPathLength, minCellCount, minCellMethod,
#'   groupCombinations, periodPriorToIndex, and addNoPaths which are trivial but
#'   can be modified.
#'
#' @param cohorts a tibble of cohorts that are built manually or using the
#'   identifyThCohorts function from this package. A valid cohorts tibble has a
#'   cohort_id, cohort_name and type columns.
#' @param ... a dot list of other options to modify in the treatment history
#'   settings
#' @export
